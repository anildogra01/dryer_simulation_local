program fixed_bed_dryer
    ...
    rhop = 38.71
    hfg = 1000.0
    ! patm is provided by PsyFun module (typically 14.696 psia at sea level)
    ! If needed, set it here: patm = 14.30
    
    ! Set product name
    iname = 'THOMPSON  '
    iprod = ' CORN     '
    
    ! Open output file (input comes from stdin via pipe)
    write(*,*) 'Opening output file FIXED.OUT...'
